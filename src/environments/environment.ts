...
export const environment = {
  ...
  baseurl: "https://justoapp.co.in/justo/modules/Mobile/api.php",
  signupurl: "https://justoapp.co.in/justo/modules/Webforms/capture.php",

    baseurl1:"https://justoapp.co.in/stagingcrm/modules/Mobile/api.php",
    signupurl1: "https://justoapp.co.in/stagingcrm/modules/Webforms/capture.php",
  production: false
};
